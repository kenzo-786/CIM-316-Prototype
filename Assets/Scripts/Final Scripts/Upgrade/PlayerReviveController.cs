...
public class PlayerReviveController : MonoBehaviour
{
    ...
    private float restoredHealthPercent = 0.5f;
    ...
    [SerializeField, Min(0f)]
    private float slowMotionDuration = 0.35f;
    ...
    [SerializeField]
    private Color revivalTextColor =
    ...
    private void TryRevive()
    {
        ...
        FeedbackEventBus.ReportWorldText(
            position,
            "REVIVED",
            revivalTextColor
        );
        ...
        slowMotionRoutine = StartCoroutine(
            SlowMotionRoutine()
        );
    }
